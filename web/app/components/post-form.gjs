...
export default class PostFormComponent extends Component {
  autosizeTextarea = modifier((element) => {
    autosize(element);
      ...
      <div class="tab-pane fade show active" id="home-pane" role="tabpanel" aria-labelledby="form-tab">
        <form {{on "submit" @onSubmit}}>
          ...
          <div class="mb-3">
            ...
            <Textarea {{this.autosizeTextarea}} {{this.setTextarea}} @value={{@post.body}} id="body" class="form-control {{if @post.errors.body "is-invalid"}}" />
